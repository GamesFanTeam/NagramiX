# План тестовой сборки NagramiX 0.1.8

## Основа проекта

NagramiX 0.1.8 создаётся на закреплённой ревизии Telegram-iOS 12.9.2 и продолжает чистую базу 0.1.7.
...
8. Создаётся файл `NagramiX-0.1.8-unsigned.ipa`.
