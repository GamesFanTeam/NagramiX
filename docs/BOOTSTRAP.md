# План тестовой сборки NagramiX 0.1.7

## Основа проекта

NagramiX 0.1.7 создаётся на закреплённой ревизии Telegram-iOS 12.9.2 и продолжает чистую базу 0.1.6.
...
8. Создаётся файл `NagramiX-0.1.7-unsigned.ipa`.
