# План тестовой сборки NagramiX 0.1.9

## Основа проекта

NagramiX 0.1.9 создаётся на закреплённой ревизии Telegram-iOS 12.9.2 и продолжает проверенную базу 0.1.8.
...
8. Создаётся файл `NagramiX-0.1.9-unsigned.ipa`.
